...
goog.provide('simplyonmyway.randomutils');
 ...
 * @constructor
 */
simplyonmyway.randomutils.sfc32 = function (uint128Hex) {
 ...
 * @return {number}
 */
simplyonmyway.randomutils.sfc32.prototype.gett = function() {
 ...
 * @constructor 
 */
simplyonmyway.randomutils.random = function() {
   {
     /**
      * @type {boolean}
      * @private
      ...
      * @private
      */
     this.prngA = new simplyonmyway.randomutils.sfc32(tokenData.hash.substr(2, 32));
      ...
      * @private
      */
     this.prngB = new simplyonmyway.randomutils.sfc32(tokenData.hash.substr(34, 32));
...
simplyonmyway.randomutils.random.prototype.random_dec = function() {
  this.useA = !this.useA;
  return this.useA ? this.prngA.gett() : this.prngB.gett();
}
// random number between a (inclusive) and b (exclusive)
/** @return {number} */
simplyonmyway.randomutils.random.prototype.random_num = function(a, b) {
  return a + (b - a) * this.random_dec();
}
// random integer between a (inclusive) and b (inclusive)
// requires a < b for proper probability distribution
/** @return {number} */
simplyonmyway.randomutils.random.prototype.random_int = function(a, b) {
  return Math.floor(this.random_num(a, b + 1));
}

// random boolean with p as percent liklihood of true
/** @return {boolean} */
simplyonmyway.randomutils.random.prototype.random_bool = function(p) {
  return this.random_dec() < p;
}
  // random value in an array of items
/** @return {number} */
simplyonmyway.randomutils.random.prototype.random_choice = function(list) {
 ...
 * @return {number}
 */
simplyonmyway.randomutils.random.prototype.random_gaussian = function(mean, sd) {
  let y1, x1, x2, w;
 ...
 * @param {number} shape
 * @return {number} */
simplyonmyway.randomutils.random.prototype.random_pareto = function(scale, shape) {
 ...
 * @param {number} shape
 * @return {number} */
simplyonmyway.randomutils.random.prototype.random_pareto_bounded = function(L, H, shape) {
  let u, num, denom;
  u = this.random_dec();
