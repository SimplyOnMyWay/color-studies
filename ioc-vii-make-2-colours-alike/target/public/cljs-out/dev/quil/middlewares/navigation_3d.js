...
var vec__16462 = axis;
var a_x = cljs.core.nth.call(null,vec__16462,(0),null);
var a_y = cljs.core.nth.call(null,vec__16462,(1),null);
var a_z = cljs.core.nth.call(null,vec__16462,(2),null);
var vec__16465 = v;
var x = cljs.core.nth.call(null,vec__16465,(0),null);
var y = cljs.core.nth.call(null,vec__16465,(1),null);
var z = cljs.core.nth.call(null,vec__16465,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__16468,p__16469){
var vec__16470 = p__16468;
var u1 = cljs.core.nth.call(null,vec__16470,(0),null);
var u2 = cljs.core.nth.call(null,vec__16470,(1),null);
var u3 = cljs.core.nth.call(null,vec__16470,(2),null);
var vec__16473 = p__16469;
var v1 = cljs.core.nth.call(null,vec__16473,(0),null);
var v2 = cljs.core.nth.call(null,vec__16473,(1),null);
var v3 = cljs.core.nth.call(null,vec__16473,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__16476_SHARP_){
return (p1__16476_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
var rotate = (function (p1__16477_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__16477_SHARP_,axis,angle);
});
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__16478_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__16478_SHARP_,angle_lr),angle_ud);
}));
}
});
...
var map__16480 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__16480__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__16480__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__16482 = cljs.core._EQ_;
var expr__16483 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__16482.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__16483))){
return straight;
} else {
if(cljs.core.truth_(pred__16482.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__16483))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__16482.call(null,quil.middlewares.navigation_3d.space,expr__16483))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__16482.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__16483))){
return up;
} else {
if(cljs.core.truth_(pred__16482.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__16483))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__16482.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__16483))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),(function (p1__16479_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__16479_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
}));
} else {
return state;
}
...
return cljs.core.update_in.call(null,user_setup.call(null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__16485_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__16485_SHARP_);
}));
});
/**
...
var map__16486_16497 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__16486_16498__$1 = (((((!((map__16486_16497 == null))))?(((((map__16486_16497.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16486_16497.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16486_16497):map__16486_16497);
var vec__16487_16499 = cljs.core.get.call(null,map__16486_16498__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_16500 = cljs.core.nth.call(null,vec__16487_16499,(0),null);
var c_y_16501 = cljs.core.nth.call(null,vec__16487_16499,(1),null);
var c_z_16502 = cljs.core.nth.call(null,vec__16487_16499,(2),null);
var vec__16490_16503 = cljs.core.get.call(null,map__16486_16498__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_16504 = cljs.core.nth.call(null,vec__16490_16503,(0),null);
var u_y_16505 = cljs.core.nth.call(null,vec__16490_16503,(1),null);
var u_z_16506 = cljs.core.nth.call(null,vec__16490_16503,(2),null);
var vec__16493_16507 = cljs.core.get.call(null,map__16486_16498__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_16508 = cljs.core.nth.call(null,vec__16493_16507,(0),null);
var p_y_16509 = cljs.core.nth.call(null,vec__16493_16507,(1),null);
var p_z_16510 = cljs.core.nth.call(null,vec__16493_16507,(2),null);
quil.core.camera.call(null,p_x_16508,p_y_16509,p_z_16510,(p_x_16508 + c_x_16500),(p_y_16509 + c_y_16501),(p_z_16510 + c_z_16502),u_x_16504,u_y_16505,u_z_16506);
