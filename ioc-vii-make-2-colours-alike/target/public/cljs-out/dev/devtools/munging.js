...
var o20746 = temp__5718__auto__;
var temp__5718__auto____$1 = (o20746["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o20747 = temp__5718__auto____$1;
return (o20747["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19669__auto__ = f;
return (o__19669__auto__["toString"]).call(o__19669__auto__);
} else {
return "";
}
}catch (e20748){var _ = e20748;
return "";
}});
...
try{var o__19669__auto___20750 = t;
(o__19669__auto___20750["cljs$lang$ctorPrWriter"]).call(o__19669__auto___20750,t,writer);
}catch (e20749){var __20751 = e20749;
}
...
var char_code = (function (){var o__19669__auto__ = (new String(char$));
return (o__19669__auto__["charCodeAt"]).call(o__19669__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19669__auto__ = String;
return (o__19669__auto__["fromCharCode"]).call(o__19669__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20752 = num_code;
switch (G__20752) {
case (1):
return (185);
...
var o__19669__auto__ = String;
return (o__19669__auto__["fromCharCode"]).call(o__19669__auto__,superscript_code);
});
/**
...
}catch (e20754){var _e__19676__auto__ = e20754;
return false;
}})())){
...
var vec__20755 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20755,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o20758 = temp__5718__auto__;
var temp__5718__auto____$1 = (o20758["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o20759 = temp__5718__auto____$1;
return (o20759["nameToPath"]);
} else {
return null;
}
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___20767]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20762){
var vec__20763 = p__20762;
var ns_detector = cljs.core.nth.call(null,vec__20763,(0),null);
...
var G__20769 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20770 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20769;
remaining_tokens = G__20770;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20760){
var G__20761 = cljs.core.first.call(null,seq20760);
var seq20760__$1 = cljs.core.next.call(null,seq20760);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20761,seq20760__$1);
}));
...
var vec__20774 = cljs.core.split_with.call(null,(function (p1__20773_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20773_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20774,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20774,(1),null);
...
var vec__20780 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20780,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20780,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20783 = cljs.core.rest.call(null,remaining_tokens);
var G__20784 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20783;
name_tokens = G__20784;
continue;
} else {
...
var vec__20787 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20787,(0),null);
var arity = cljs.core.nth.call(null,vec__20787,(1),null);
var vec__20790 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20790,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20790,(1),null);
var vec__20793 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20793,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20793,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20793,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20793,(3),null);
...
var vec__20799 = result;
var munged_ns = cljs.core.nth.call(null,vec__20799,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20799,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20799,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20799,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20799,(4),null);
var arity = cljs.core.nth.call(null,vec__20799,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__20803 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__20803,(0),null);
var args = cljs.core.nth.call(null,vec__20803,(1),null);
var vec__20806 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20806,(0),null);
var name = cljs.core.nth.call(null,vec__20806,(1),null);
...
var G__20809 = (arity + (1));
var G__20810 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20811){
var vec__20812 = p__20811;
var arity = cljs.core.nth.call(null,vec__20812,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20812,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__20815_SHARP_){
return cljs.core.get.call(null,arities,p1__20815_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__20816_SHARP_){
return cljs.core.drop.call(null,(2),p1__20816_SHARP_);
}),sorted_infos);
...
args__4742__auto__.push((arguments[i__4737__auto___20824]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20819){
var vec__20820 = p__20819;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20820,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20817){
var G__20818 = cljs.core.first.call(null,seq20817);
var seq20817__$1 = cljs.core.next.call(null,seq20817);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20818,seq20817__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__20828__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20828__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20828__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20828__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20829 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20829,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20829,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20829,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20829,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20829,(4),null);
var arity = cljs.core.nth.call(null,vec__20829,(5),null);
...
var o__19669__auto__ = f;
return (o__19669__auto__["getBasis"]).call(o__19669__auto__);
});
/**
...
}catch (e20833){var _e__19676__auto__ = e20833;
...
var G__20834 = (obj[cljs.core.first.call(null,path)]);
var G__20835 = cljs.core.rest.call(null,path);
obj = G__20834;
path = G__20835;
continue;
} else {
...
var _STAR_ = (function (accum,p__20836){
var vec__20837 = p__20836;
var bit = cljs.core.nth.call(null,vec__20837,(0),null);
var protocol = cljs.core.nth.call(null,vec__20837,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20840){
var vec__20841 = p__20840;
var ns = cljs.core.nth.call(null,vec__20841,(0),null);
var name = cljs.core.nth.call(null,vec__20841,(1),null);
var selector = cljs.core.nth.call(null,vec__20841,(2),null);
...
var post_process = (function (p__20845){
var vec__20846 = p__20845;
var munged_name = cljs.core.nth.call(null,vec__20846,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20846,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__20844_SHARP_){
return (obj[cljs.core.first.call(null,p1__20844_SHARP_)]);
}),sorted_matches);
