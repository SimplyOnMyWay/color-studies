...
var file = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e22654){var _e = e22654;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___22657 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___22657)){
var seen_errors_22658 = temp__5718__auto___22657;
if(cljs.core.truth_(seen_errors_22658.has(self))){
} else {
seen_errors_22658.add(self);

var temp__5720__auto___22659 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___22659)){
var sense_22660 = temp__5720__auto___22659;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22660)].join(''));
} else {
}
}
} else {
