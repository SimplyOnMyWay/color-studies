...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20923){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20924,G__20925,seq20923__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20929_SHARP_){
return (!((cljs.core.meta.call(null,p1__20929_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__20930__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20934){var _e__19676__auto__ = e20934;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e20936){var _e__19676__auto__ = e20936;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__20938 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__20939 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__20939);

try{var map__20940 = opts;
...
var markup_db = cljs.core.get.call(null,map__20940__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__20938);
}});
...
var temp__5718__auto___20945 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___20945)){
var managed_print_level_20946 = temp__5718__auto___20945;
var _STAR_print_level_STAR__orig_val__20943_20947 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__20944_20948 = managed_print_level_20946;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__20944_20948);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__20942_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20942_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__20943_20947);
}} else {
job_fn.call(null);
}
