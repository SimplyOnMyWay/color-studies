...
var c_19265 = (new goog.debug.Console());
var G__19264_19266 = c_19265.getFormatter();
goog.object.set(G__19264_19266,"showAbsoluteTime",false);

goog.object.set(G__19264_19266,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_19265);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__19267_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__19267_SHARP_);
