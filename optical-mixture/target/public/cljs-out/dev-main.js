window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=5be037&fwbuild=dev"};
...
document.write('<script>goog.require("simplyonmyway.om");</script>');
