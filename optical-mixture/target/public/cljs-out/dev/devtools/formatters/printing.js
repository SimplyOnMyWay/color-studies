...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16949){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16950,G__16951,seq16949__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16955_SHARP_){
return (!((cljs.core.meta.call(null,p1__16955_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__16956__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16960){var _e__15934__auto__ = e16960;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e16962){var _e__15934__auto__ = e16962;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16964 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16965 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16965);

try{var map__16966 = opts;
...
var markup_db = cljs.core.get.call(null,map__16966__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16964);
}});
...
var temp__5718__auto___16971 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16971)){
var managed_print_level_16972 = temp__5718__auto___16971;
var _STAR_print_level_STAR__orig_val__16969_16973 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16970_16974 = managed_print_level_16972;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16970_16974);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__16968_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16968_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16969_16973);
}} else {
job_fn.call(null);
}
