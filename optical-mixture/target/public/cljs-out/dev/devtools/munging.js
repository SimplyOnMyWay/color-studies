...
var o16818 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16818["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16819 = temp__5718__auto____$1;
return (o16819["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15927__auto__ = f;
return (o__15927__auto__["toString"]).call(o__15927__auto__);
} else {
return "";
}
}catch (e16820){var _ = e16820;
return "";
}});
...
try{var o__15927__auto___16822 = t;
(o__15927__auto___16822["cljs$lang$ctorPrWriter"]).call(o__15927__auto___16822,t,writer);
}catch (e16821){var __16823 = e16821;
}
...
var char_code = (function (){var o__15927__auto__ = (new String(char$));
return (o__15927__auto__["charCodeAt"]).call(o__15927__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15927__auto__ = String;
return (o__15927__auto__["fromCharCode"]).call(o__15927__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16824 = num_code;
switch (G__16824) {
case (1):
return (185);
...
var o__15927__auto__ = String;
return (o__15927__auto__["fromCharCode"]).call(o__15927__auto__,superscript_code);
});
/**
...
}catch (e16826){var _e__15934__auto__ = e16826;
return false;
}})())){
...
var vec__16827 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16827,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o16830 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16830["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16831 = temp__5718__auto____$1;
return (o16831["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16834){
var vec__16835 = p__16834;
var ns_detector = cljs.core.nth.call(null,vec__16835,(0),null);
...
var G__16841 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16842 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16841;
remaining_tokens = G__16842;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16832){
var G__16833 = cljs.core.first.call(null,seq16832);
var seq16832__$1 = cljs.core.next.call(null,seq16832);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16833,seq16832__$1);
}));
...
var vec__16846 = cljs.core.split_with.call(null,(function (p1__16845_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16845_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16846,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16846,(1),null);
...
var vec__16852 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16852,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16852,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16855 = cljs.core.rest.call(null,remaining_tokens);
var G__16856 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16855;
name_tokens = G__16856;
continue;
} else {
...
var vec__16859 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16859,(0),null);
var arity = cljs.core.nth.call(null,vec__16859,(1),null);
var vec__16862 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16862,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16862,(1),null);
var vec__16865 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16865,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16865,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16865,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16865,(3),null);
...
var vec__16871 = result;
var munged_ns = cljs.core.nth.call(null,vec__16871,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16871,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16871,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16871,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16871,(4),null);
var arity = cljs.core.nth.call(null,vec__16871,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16875 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16875,(0),null);
var args = cljs.core.nth.call(null,vec__16875,(1),null);
var vec__16878 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16878,(0),null);
var name = cljs.core.nth.call(null,vec__16878,(1),null);
...
var G__16881 = (arity + (1));
var G__16882 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16883){
var vec__16884 = p__16883;
var arity = cljs.core.nth.call(null,vec__16884,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16884,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16887_SHARP_){
return cljs.core.get.call(null,arities,p1__16887_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__16888_SHARP_){
return cljs.core.drop.call(null,(2),p1__16888_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16891){
var vec__16892 = p__16891;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16892,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16889){
var G__16890 = cljs.core.first.call(null,seq16889);
var seq16889__$1 = cljs.core.next.call(null,seq16889);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16890,seq16889__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16900__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16900__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16900__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16900__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16901 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16901,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16901,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16901,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16901,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16901,(4),null);
var arity = cljs.core.nth.call(null,vec__16901,(5),null);
...
var o__15927__auto__ = f;
return (o__15927__auto__["getBasis"]).call(o__15927__auto__);
});
/**
...
}catch (e16905){var _e__15934__auto__ = e16905;
...
var G__16906 = (obj[cljs.core.first.call(null,path)]);
var G__16907 = cljs.core.rest.call(null,path);
obj = G__16906;
path = G__16907;
continue;
} else {
...
var _STAR_ = (function (accum,p__16908){
var vec__16909 = p__16908;
var bit = cljs.core.nth.call(null,vec__16909,(0),null);
var protocol = cljs.core.nth.call(null,vec__16909,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16912){
var vec__16913 = p__16912;
var ns = cljs.core.nth.call(null,vec__16913,(0),null);
var name = cljs.core.nth.call(null,vec__16913,(1),null);
var selector = cljs.core.nth.call(null,vec__16913,(2),null);
...
var post_process = (function (p__16917){
var vec__16918 = p__16917;
var munged_name = cljs.core.nth.call(null,vec__16918,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16918,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16916_SHARP_){
return (obj[cljs.core.first.call(null,p1__16916_SHARP_)]);
}),sorted_matches);
