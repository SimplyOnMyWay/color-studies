...
var file = cljs.core.get.call(null,map__19433__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19433__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19433__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e19432){var _e = e19432;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___19435 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___19435)){
var seen_errors_19436 = temp__5718__auto___19435;
if(cljs.core.truth_(seen_errors_19436.has(self))){
} else {
seen_errors_19436.add(self);

var temp__5720__auto___19437 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___19437)){
var sense_19438 = temp__5720__auto___19437;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19438)].join(''));
} else {
}
}
} else {
