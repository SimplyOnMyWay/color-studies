...
var vec__15761 = axis;
var a_x = cljs.core.nth.call(null,vec__15761,(0),null);
var a_y = cljs.core.nth.call(null,vec__15761,(1),null);
var a_z = cljs.core.nth.call(null,vec__15761,(2),null);
var vec__15764 = v;
var x = cljs.core.nth.call(null,vec__15764,(0),null);
var y = cljs.core.nth.call(null,vec__15764,(1),null);
var z = cljs.core.nth.call(null,vec__15764,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__15767,p__15768){
var vec__15769 = p__15767;
var u1 = cljs.core.nth.call(null,vec__15769,(0),null);
var u2 = cljs.core.nth.call(null,vec__15769,(1),null);
var u3 = cljs.core.nth.call(null,vec__15769,(2),null);
var vec__15772 = p__15768;
var v1 = cljs.core.nth.call(null,vec__15772,(0),null);
var v2 = cljs.core.nth.call(null,vec__15772,(1),null);
var v3 = cljs.core.nth.call(null,vec__15772,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__15775_SHARP_){
return (p1__15775_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
var rotate = (function (p1__15776_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__15776_SHARP_,axis,angle);
});
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__15777_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__15777_SHARP_,angle_lr),angle_ud);
}));
}
});
...
var map__15779 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__15779__$1 = (((((!((map__15779 == null))))?(((((map__15779.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15779.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15779):map__15779);
var up = cljs.core.get.call(null,map__15779__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__15779__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__15781 = cljs.core._EQ_;
var expr__15782 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__15781.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__15782))){
return straight;
} else {
if(cljs.core.truth_(pred__15781.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__15782))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__15781.call(null,quil.middlewares.navigation_3d.space,expr__15782))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__15781.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__15782))){
return up;
} else {
if(cljs.core.truth_(pred__15781.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__15782))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__15781.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__15782))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),(function (p1__15778_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__15778_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
}));
} else {
return state;
}
...
return cljs.core.update_in.call(null,user_setup.call(null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__15784_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__15784_SHARP_);
}));
});
/**
...
var map__15785_15796 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__15785_15797__$1 = (((((!((map__15785_15796 == null))))?(((((map__15785_15796.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15785_15796.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15785_15796):map__15785_15796);
var vec__15786_15798 = cljs.core.get.call(null,map__15785_15797__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_15799 = cljs.core.nth.call(null,vec__15786_15798,(0),null);
var c_y_15800 = cljs.core.nth.call(null,vec__15786_15798,(1),null);
var c_z_15801 = cljs.core.nth.call(null,vec__15786_15798,(2),null);
var vec__15789_15802 = cljs.core.get.call(null,map__15785_15797__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_15803 = cljs.core.nth.call(null,vec__15789_15802,(0),null);
var u_y_15804 = cljs.core.nth.call(null,vec__15789_15802,(1),null);
var u_z_15805 = cljs.core.nth.call(null,vec__15789_15802,(2),null);
var vec__15792_15806 = cljs.core.get.call(null,map__15785_15797__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_15807 = cljs.core.nth.call(null,vec__15792_15806,(0),null);
var p_y_15808 = cljs.core.nth.call(null,vec__15792_15806,(1),null);
var p_z_15809 = cljs.core.nth.call(null,vec__15792_15806,(2),null);
quil.core.camera.call(null,p_x_15807,p_y_15808,p_z_15809,(p_x_15807 + c_x_15799),(p_y_15808 + c_y_15800),(p_z_15809 + c_z_15801),u_x_15803,u_y_15804,u_z_15805);
